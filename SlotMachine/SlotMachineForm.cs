 ...
 * Authors Name: Jeremiah Hughes
 * Student ID 200318676
 * App creation date 16/12/2016
 * App description: A slot machine app for gambling virtual credits with no expense to your 
 * own wallet.
 */
namespace SlotMachine
{
    public partial class SlotMachineForm : Form
    {
        ...
        private void resetAll()
        {
            ...
            //Resets all the labels and images
            PictureBoxReelOne.Image = Properties.Resources.seven;
            PictureBoxReelTwo.Image = Properties.Resources.seven;
            PictureBoxReelThree.Image = Properties.Resources.seven;
            LabelTotalCredits.Text = "1000";
            LabelBet.Text = "0";
            LabelWinnerPaid.Text = "0";
            LabelCurrentJackpot.Text = "5000";
    ...
    e.g. Bar - Orange - Banana */
        ...
        /// <summary>
        /// Resets the slot machine application
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PitureBoxReset_Click(object sender, EventArgs e)
        {
            resetAll();
        }
        /// <summary>
        ...
        /// <summary>
        /// Makes sure the player has the money to bet and updates the LabelBet.
        /// </summary>
        /// <param name="bet"></param>
        private void Bet(int bet)
        {
            playerBet = Convert.ToInt16(LabelBet.Text);
            int credits = Convert.ToInt16(LabelTotalCredits.Text);

            if(credits - playerBet <= 0)
            {
                MessageBox.Show("You need more credits Sorry!");
            }
            else
            {
                credits = credits - bet;
                ...
                LabelBet.Text = playerBet.ToString();
            }
        }
        /// <summary>
        /// Uses the Bet(); Allowing the player to add money to his bed
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PictureBoxBet1_Click(object sender, EventArgs e)
        {
            Bet(1);
        }
        /// <summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PictureBoxBet10_Click(object sender, EventArgs e)
        {
            Bet(10);
        }
        /// <summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PictureBoxBet25_Click(object sender, EventArgs e)
        {
            Bet(25);
        }
        /// <summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PictureBoxBet50_Click(object sender, EventArgs e)
        {
            Bet(50);
        }
        /// <summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PictureBoxBet100_Click(object sender, EventArgs e)
        {
            Bet(100);
        }
    }
